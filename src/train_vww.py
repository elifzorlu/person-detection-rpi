...
def main(argv):
  ...
  if len(argv) >= 3:
    ...
    model.save('trained_models/vww_96_small.h5')



def train_epochs(model, train_generator, val_generator, epoch_count, learning_rate):
    model.compile(
    ...
    callbacks = [
        tf.keras.callbacks.ModelCheckpoint(
            'trained_models/vww_96_small_best.h5',
